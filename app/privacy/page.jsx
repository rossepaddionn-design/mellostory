  ...
  <li>Рекламное пространство <strong>не продаётся</strong> третьим лицам.</li>
            ...
            <section>
              ...
              <ul className="list-disc list-inside mt-2 space-y-1 ml-4">
                ...
                <li>Предоставление возможности оставлять предложения, оценки, комментарии и сообщения.</li>
            ...
            <section>
              ...
              <ul className="list-disc list-inside space-y-1 ml-4">
                <li><strong>Администрация Сайта:</strong> имеет доступ к вашему email, никнейму, предложениям, сообщениям, комментариям и оценкам. Пароли недоступны.</li>
              </ul>
