      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-8 py-8 sm:py-12">
        ...
        <div className="bg-gray-900 bg-opacity-95 rounded-2xl p-6 sm:p-10 border-2 border-red-600">
          ...
          <div className="space-y-6 text-gray-300 text-sm sm:text-base leading-relaxed">
            ...
            <section>
              <h2 className="text-xl sm:text-2xl font-bold text-red-400 mb-3">2. Некоммерческий характер проекта</h2>
              <p>
              ...
              <h3 className="text-lg font-semibold text-red-300 mt-4 mb-2">2.1. Отсутствие коммерческой деятельности</h3>
              <ul className="list-disc list-inside mt-2 space-y-1 ml-4">
              ...
              <h3 className="text-lg font-semibold text-red-300 mt-4 mb-2">2.2. Отсутствие рекламы</h3>
              <p>
                <strong>На Сайте никогда не будет рекламы.</strong>
              </p>
              <ul className="list-disc list-inside mt-2 space-y-1 ml-4">
                <li>Мы <strong>не размещаем</strong> рекламные баннеры, всплывающие окна или видеорекламу.</li>
                <li>Мы <strong>не сотрудничаем</strong> с рекламными сетями (Google AdSense, Яндекс.Директ и т.д.).</li>
                <li>Мы <strong>не используем</strong> партнёрские программы или реферальные ссылки.</li>
                <li>Мы <strong>не продаём</strong> рекламное пространство третьим лицам.</li>
              </ul>
              <p className="mt-2">
              ...
              <h3 className="text-lg font-semibold text-red-300 mt-4 mb-2">2.3. Цели проекта</h3>
              <p>
            ...
            <section>
              <h2 className="text-xl sm:text-2xl font-bold text-red-400 mb-3">3. Характер контента и отсутствие пропаганды</h2>
              <p>
              ...
              <h3 className="text-lg font-semibold text-red-300 mt-4 mb-2">3.3. Отсутствие пропаганды</h3>
              <p>
            ...
            <section>
              <h2 className="text-xl sm:text-2xl font-bold text-red-400 mb-3">2. Контролёр данных</h2>
              <p>
              ...
              <p className="mt-2">
                ...
                Email: <a href="mailto:mellostory@protonmail.com" className="text-red-500 hover:text-red-400 underline">mellostory@protonmail.com</a>
              </p>
            </section>

            <section>
              <h2 className="text-xl sm:text-2xl font-bold text-red-400 mb-3">3. Какие данные мы собираем</h2>
              <p>При использовании Сайта мы можем собирать следующие категории персональных данных:</p>
              
              <h3 className="text-lg font-semibold text-red-300 mt-4 mb-2">3.1. Данные, предоставляемые пользователем</h3>
              <ul className="list-disc list-inside mt-2 space-y-1 ml-4">
              ...
              <h3 className="text-lg font-semibold text-red-300 mt-4 mb-2">3.2. Технические данные (собираются автоматически)</h3>
              <ul className="list-disc list-inside mt-2 space-y-1 ml-4">
                <li>IP-адрес</li>
              ...
              <h3 className="text-lg font-semibold text-red-300 mt-4 mb-2">3.3. Важная информация о паролях</h3>
              <p>
                Пароли хранятся в зашифрованном виде с использованием алгоритма <strong>bcrypt</strong> и недоступны администрации Сайта. Мы не имеем технической возможности просматривать ваши пароли.
              </p>
            </section>

            <section>
              <h2 className="text-xl sm:text-2xl font-bold text-red-400 mb-3">4. Правовые основания обработки данных</h2>
              <p>
              ...
              <ul className="list-disc list-inside mt-2 space-y-1 ml-4">
                ...
                <li><strong>Исполнение договора (Art. 6(1)(b) GDPR):</strong> Обработка данных необходима для предоставления вам услуг Сайта (авторизация, комментарии, закладки).</li>
                <li><strong>Законные интересы (Art. 6(1)(f) GDPR):</strong> Анализ статистики и улучшение работы Сайта.</li>
              </ul>
            </section>

            <section>
              <h2 className="text-xl sm:text-2xl font-bold text-red-400 mb-3">5. Цели обработки данных</h2>
              ...
              <p className="mt-2">
                <strong>Мы не используем ваши данные для:</strong>
              </p>
              <ul className="list-disc list-inside mt-2 space-y-1 ml-4">
            ...
            <section>
              <h2 className="text-xl sm:text-2xl font-bold text-red-400 mb-3">6. Кто имеет доступ к вашим данным</h2>
              
              <h3 className="text-lg font-semibold text-red-300 mt-4 mb-2">6.1. Внутренний доступ</h3>
              ...
              <h3 className="text-lg font-semibold text-red-300 mt-4 mb-2">6.2. Третьи стороны (обработчики данных)</h3>
              <ul className="list-disc list-inside space-y-1 ml-4">
              ...
              <h3 className="text-lg font-semibold text-red-300 mt-4 mb-2">6.3. Передача данных за пределы ЕС</h3>
              <p>
                Ваши данные могут передаваться на серверы, расположенные за пределами Европейского Союза (США). Передача осуществляется в соответствии с требованиями GDPR (статья 46) на основе стандартных договорных оговорок (Standard Contractual Clauses).
              </p>

              <h3 className="text-lg font-semibold text-red-300 mt-4 mb-2">6.4. Гарантии конфиденциальности</h3>
              <p>
                Мы <strong>не продаём, не передаём и не предоставляем</strong> ваши персональные данные третьим лицам для их собственных целей, за исключением случаев, предусмотренных законодательством (судебные запросы, требования правоохранительных органов).
              </p>
            </section>

            <section>
              <h2 className="text-xl sm:text-2xl font-bold text-red-400 mb-3">7. Срок хранения данных</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl sm:text-2xl font-bold text-red-400 mb-3">8. Ваши права в соответствии с GDPR</h2>
              ...
              <ul className="list-disc list-inside mt-2 space-y-2 ml-4">
                ...
                <li><strong>Право на подачу жалобы:</strong> Вы можете подать жалобу в надзорный орган по защите данных вашей страны или Германии (Bundesbeauftragter für den Datenschutz und die Informationsfreiheit — BfDI).</li>
              </ul>
              
              <p className="mt-4">
                <strong>Как реализовать свои права:</strong><br />
                Свяжитесь с нами по адресу: <a href="mailto:mellostory@protonmail.com" className="text-red-500 hover:text-red-400 underline">mellostory@protonmail.com</a><br />
                Мы ответим на ваш запрос в течение <strong>30 дней</strong> в соответствии с требованиями GDPR.
              </p>
            </section>

            <section>
              <h2 className="text-xl sm:text-2xl font-bold text-red-400 mb-3">9. Безопасность данных</h2>
              <p>
              ...
              <ul className="list-disc list-inside mt-2 space-y-1 ml-4">
                ...
                <li><strong>Ограничение доступа:</strong> Доступ к серверам и базам данных имеют только авторизованные администраторы.</li>
              ...
              <p className="mt-2">
                <strong>Важно:</strong> Несмотря на наши усилия, ни одна система не может гарантировать 100% безопасность. Мы рекомендуем использовать надёжные пароли и не разглашать их третьим лицам.
              </p>
            </section>

            <section>
              <h2 className="text-xl sm:text-2xl font-bold text-red-400 mb-3">10. Cookies и локальное хранилище</h2>
              
              <h3 className="text-lg font-semibold text-red-300 mt-4 mb-2">10.1. Использование localStorage</h3>
              <p>
              ...
              <h3 className="text-lg font-semibold text-red-300 mt-4 mb-2">10.2. Cookies</h3>
              <p>
              ...
              <h3 className="text-lg font-semibold text-red-300 mt-4 mb-2">10.3. Аналитика</h3>
              <p>
            ...
            <section>
              <h2 className="text-xl sm:text-2xl font-bold text-red-400 mb-3">11. Блокировка и модерация</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl sm:text-2xl font-bold text-red-400 mb-3">12. Данные несовершеннолетних</h2>
              <p>
                <strong>Сайт предназначен исключительно для лиц старше 18 лет.</strong>
              </p>
              <p className="mt-2">
                Мы сознательно не собираем персональные данные лиц младше 18 лет. Если нам станет известно, что мы непреднамеренно собрали данные несовершеннолетнего, мы немедленно удалим такую информацию.
              </p>
              <p className="mt-2">
                Если вы считаете, что несовершеннолетний предоставил нам свои данные, свяжитесь с нами по адресу <a href="mailto:mellostory@protonmail.com" className="text-red-500 hover:text-red-400 underline">mellostory@protonmail.com</a>
              </p>
            </section>

            <section>
              <h2 className="text-xl sm:text-2xl font-bold text-red-400 mb-3">13. Утечки данных</h2>
              <p>
            ...
            <section>
              ...
              <p>
                Мы оставляем за собой право вносить изменения в настоящую Политику конфиденциальности в любое время. Все изменения вступают в силу с момента публикации новой версии на Сайте.
              </p>
              <p className="mt-2">
            ...
            <section>
              <h2 className="text-xl sm:text-2xl font-bold text-red-400 mb-3">15. Контактная информация</h2>
              <p>
              ...
              <p className="mt-2">
                Мы ответим на ваш запрос в течение 30 дней в соответствии с требованиями GDPR.
              </p>
              <p className="mt-4">
