        ...
        <div className="bg-gray-900 bg-opacity-95 rounded-2xl p-6 sm:p-10 border-2 border-red-600">
          ...
          <div className="space-y-6 text-gray-300 text-sm sm:text-base leading-relaxed">
            ...
            <section>
              ...
              <p>
                Несанкционированное использование контента Сайта влечёт ответственность в соответствии с:
              </p>
              <ul className="list-disc list-inside mt-2 space-y-1 ml-4">
                <li><strong>Законодательством РФ:</strong>
                  <ul className="list-circle list-inside ml-6 mt-1 space-y-1">
                    <li>Статьи 1252-1253 Гражданского кодекса РФ (защита исключительных прав, взыскание компенсации до 5 000 000 рублей)</li>
                    <li>Статья 146 Уголовного кодекса РФ (нарушение авторских прав в крупном размере — штраф до 200 000 рублей или лишение свободы до 2 лет)</li>
                  </ul>
                </li>
                <li><strong>Законодательством Германии:</strong>
                  <ul className="list-circle list-inside ml-6 mt-1 space-y-1">
                    <li>Urheberrechtsgesetz (UrhG) §§ 97, 106 — Закон об авторском праве (возмещение убытков, запретительные меры)</li>
                    <li>§ 106 UrhG — Уголовная ответственность за нарушение авторских прав (штраф или лишение свободы до 3 лет)</li>
                  </ul>
                </li>
                <li><strong>Международное право:</strong>
                  <ul className="list-circle list-inside ml-6 mt-1 space-y-1">
                    <li>Бернская конвенция об охране литературных и художественных произведений</li>
                    <li>Директива ЕС 2001/29/EC о гармонизации авторского права</li>
                  </ul>
                </li>
              </ul>
              <p className="mt-2 font-semibold text-yellow-400">
                ⚠️ Администрация оставляет за собой право обращаться в правоохранительные органы и подавать иски о взыскании компенсации при выявлении нарушений авторских прав.
              </p>
            </section>
